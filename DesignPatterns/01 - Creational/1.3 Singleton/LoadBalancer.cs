    ...
    internal sealed class LoadBalancer
    {
        ...
        private LoadBalancer()
        {
            _servers = new List<Server>
            {
                ...
                new Server{ Id = Guid.NewGuid(), Name = "ServerIII" , IP = "120.14.220.21"},
                new Server{ Id = Guid.NewGuid(), Name = "ServerIV" , IP = "120.14.220.22"},
                new Server{ Id = Guid.NewGuid(), Name = "ServerV" , IP = "120.14.220.23"},
            };
        }
